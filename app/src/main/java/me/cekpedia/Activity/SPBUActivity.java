...
//    SearchView searchView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.list_spbu);
...
//        listView = (ListView) findViewById(R.id.listviewspbu);
//        searchView = (SearchView) findViewById(R.id.cari);
//        mResult = (RecyclerView) findViewById(R.id.result_list_spbu);
...
//            }
//        });
//        mDatabaseRef = FirebaseDatabase.getInstance().getReference(FB_DATABASE_PATH).child("cekpediaItem").child("spbu");
//
...
//
//                mAdapter = new ImageListAdapter(SPBUActivity.this, R.layout.list_item, imgList, "spbu");
...
//                Toast.makeText(SPBUActivity.this, "Database Error", Toast.LENGTH_SHORT).show();
//            }
//        });
...
//        Intent intent = new Intent(SPBUActivity.this, SubMenuActivity.class);
