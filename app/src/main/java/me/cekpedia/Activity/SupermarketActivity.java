...
//        recyclerView = (RecyclerView) findViewById(R.id.list_swalayan);
//
...
//        recyclerView.setAdapter(adapter);
        ...
        listView = (ListView) findViewById(R.id.list_swalayan);
        final ArrayList<String> Kategori = new ArrayList<>();
//        searchView = (SearchView) findViewById(R.id.cari);
//        mResult = (RecyclerView) findViewById(R.id.result_list_supermarket);
        ...
        mDatabaseRef = FirebaseDatabase.getInstance().getReference(FB_DATABASE_PATH).child("cekpediaItem").child("supermarket");
...
//                Log.d("TAG", nama + " / " + Lokasi + " / " + imgurl);
                ...
                mAdapter = new ImageListAdapter(SupermarketActivity.this, R.layout.list_item, imgList, "supermarket");
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(SupermarketActivity.this, "Database Error", Toast.LENGTH_SHORT).show();
            }
        });

    }
    public void tomaps(View view){
        Intent intent = new Intent(SupermarketActivity.this, SubMenuActivity.class);
